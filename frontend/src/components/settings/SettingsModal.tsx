...
import { X, Settings, User, MapPin, Bell, Shield, Moon, Save, Lock, Trash2 } from 'lucide-react';
...
export const SettingsModal: React.FC<SettingsModalProps> = ({
  ...
  const [activeTab, setActiveTab] = useState<'account' | 'location' | 'notifications' | 'privacy' | 'safety' | 'appearance'>('account');
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-2xl overflow-hidden shadow-2xl relative my-6">
        ...
        <form onSubmit={handleSave} className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
          ...
          <div className="flex justify-end gap-3 pt-4 border-t border-slate-800">
            ...
            <button
              type="submit"
              className="px-5 py-2 rounded-xl bg-violet-600 hover:bg-violet-500 text-white text-xs font-bold flex items-center gap-1.5 shadow-lg"
            >
